        ...
        <div className="text-center mb-5" data-aos="fade-down">
          ...
          <div className="row g-3 mb-4">
            <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <a href="mailto:manojbhaskar01234@gmail.com" className="text-decoration-none text-white">
                <div className="card bg-white bg-opacity-10 border-0 h-100 card-hover contact-card-hover">
                  <div className="card-body text-center py-4 px-3">
                    ...
                    <p className="small opacity-75 mb-0">manojbhaskar01234@gmail.com</p>
                  </div>
                </div>
              </a>
            </div>
            ...
            <div key={0} className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <a href="tel:+918317557678" className="text-decoration-none text-white">
                <div className="card bg-white bg-opacity-10 border-0 h-100 card-hover contact-card-hover">
                  <div className="card-body text-center py-4 px-3">
                    <i className="fas fa-phone fs-2 mb-3"></i>
                    <h3 className="h6 fw-semibold mb-2">Phone</h3>
                    <p className="small opacity-75 mb-0">+91 8317557678</p>
                  </div>
                </div>
              </a>
            </div>
            ...
            <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <a href="https://linkedin.com/in/manoj-bhaskar-99b842234/" rel="noreferrer" target="_blank" className="text-decoration-none text-white">
                <div className="card bg-white bg-opacity-10 border-0 h-100 card-hover contact-card-hover">
                  <div className="card-body text-center py-4 px-3">
            ...
            <div className="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <a href="https://github.com/Manoj584" rel="noreferrer" target="_blank" className="text-decoration-none text-white">
                <div className="card bg-white bg-opacity-10 border-0 h-100 card-hover contact-card-hover">
                  <div className="card-body text-center py-4 px-3">
